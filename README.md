...
- Een BEVOEGDHEID betreft een tekstfragment waarmee een bestuursorgaan de bevoegdheid krijgt om een bepaalde (rechts)handeling uit te voeren.
- Een RECHTSCHEPPING betreft een tekstfragment waarmee een rechtssubject (natuurlijk persoon of rechtspersoon) de mogelijkheid krijgt om een bepaalde rechtshandeling uit te voeren.
- Een VERBOD betreft een tekstfragment waarmee verboden wordt om een bepaalde (rechts)handeling uit te voeren.
...
- Een DELEGATIE betreft een tekstfragment waarmee een bevoegdheid wordt gegeven om nadere regels te stellen in onderliggende regelgeving. Kenmerkend is (vaak) het gebruik van tekstfragmenten als "Bij ministeriële regeling..." of "Bij algemene maatregel van bestuur..." of "Bij of krachtens...".
...
- Gedragsbepalingen gaan direct over zo'n handeling;
- De vrijstellingsbepaling gaat weer over een andere gedragsbepaling (en is zo indirect gekoppeld aan een handeling);

...
2. De tweede laag is de [juridische wegenkaart](#juridischewegenkaart). Dit betreft een kaart van wegen die door het juridisch landschap lopen. Juridische teksten gaan ergens over: ze definiëren begrippen en normeren gedrag. Verschillende artikelen kunnen daarbij gaan over dezelfde begrippen of het zelfde gedrag. De juridische wegenkaart verbindt deze artikelen: zo kun je direct zien welke artikelen met elkaar verbonden zijn en over "hetzelfde" gaan. Door elk punt van het landschap (bijvoorbeeld een lid van een artikel van wet) zullen meerdere wegen lopen. De juridische wegenkaart laat wel zijn *welke* wegen er allemaal zijn. En ook laat het zien hoe je van de ene plek naar de andere kunt komen, en hoe die plekken met elkaar in verband staan (of juist niet).
...
Dit artikel is een duidelijk geval van een [bepaling](#bepaling) waarin een [bevoegdheid](#bevoegdheid) wordt geregeld. Het betreft een bevoegdheid met betrekking tot de [handeling](#handeling) «verlenen individuele inkomenstoeslag». De [normadressaat](#normadressaat), degene tot wie deze [gedragsnorm](#gedragsnorm) is gericht, betreft «het college». Die krijgt de bevoegdheid.

Er gebeurt echt nog meer in dit tekstfragment. Het fragment bevat ook nog twee [voorwaarden](#voorwaarde). De eerste voorwaarde is materieel en beperkt de bevoegdheid. De bevoegdheid is onder de voorwaarde dat:

- De aanvraag is ingediend door een persoon van 21 jaar of ouder, doch jonger dan de pensioengerechtigde leeftijd, EN
- Waarbij sprake is van een langdurig en laag inkomen, EN
- Die geen in aanmerking te nemen vermogen als bedoeld in artikel 34 heeft, EN
- Die geen uitzicht heeft op inkomensverbetering.
...
- Pensioengerechtigde leeftijd (artikel 1 sub m Pw, verwijst naar artikel 7a lid 1 AOW);
- Langdurig en laag inkomen (artikel 8 lid 2 Pw);
- vermogen als bedoeld in artikel 34 (artikel 34 Pw);
- uitzicht op inkomensverbetering;
- omstandigheden van de persoon (artikel 36 lid 2 Pw).
...
Artikel 8 lid 1 sub b bevat een [delegatie](#delegatie)-bepaling die de gemeenteraad verplicht tot het opstellen van een verordening met daarin regels met betrekking tot een individuele inkomenstoeslag. Met artikel 8 lid 2 omvat die verplichting ook een verplichting om een begrips-bepaling op te nemen met betrekking tot de begrippen langdurig en laag inkomen.

We nemen in dit voorbeeld de gemeente Utrecht als voorbeeld. De bron die we nodig hebben is in dit geval de [Verordening individuele inkomenstoeslag gemeente Utrecht](https://lokaleregelgeving.overheid.nl/CVDR729770/1). Het tekstfragment Artikel 2 van deze bron geeft ons de definitie:
...
Dit betreft een [begripsbepaling](#begripsbepaling), betreffende het begrip "langdurig laag inkomen". Deze bepaling maakt weer gebruik van twee andere begrippen, die we ook weer zoeken:

- referteperiode (artikel 1 sub d van de verordening);
- van toepassing zijnde bijstandsnorm (artikel 1 sub e van de verordening, verwijst naar artikel 5 sub c Pw, paragraaf 3.3 Pw en artikel 22a Pw)
...
![](kennisgraaf-laag2.svg "kennisgraaf laag 2")

## Derde laag: de juridische etappes - de feit-gevolg-paren {#juridischeverbindingen}
